...
#被咬怎麼半(undo)
    ...
    if text == '被蛇咬到怎麼辦':
        ...
        url = 'https://imgur.com/a/oo5zsu5'
        
        text1 = '    等待就醫時，先做初步的處置'
        text2 = '1.保持冷靜勿驚慌，離開毒蛇可能攻擊到的範圍，立即打119求救'
        text3 = '2.脫去受傷處的衣物、手錶、戒指等束縛物'
        text4 = '3.避免喝含有酒精或咖啡因的飲品'
        text5 = '4.減緩毒液擴散：盡量減少活動，心情跟呼吸保持平靜，減少血液循環的加速。 患肢保持不動，而且位置要低於心臟的高度'
        text6 = '5.不要冰敷，避免冰敷使循環變差，造成組織大量壞死'
        text7 = '6.點選下方功能表查詢「我遇到什麼種類的蛇」，可以得出您遇到蛇的種類及得出是否需要注射血清'
...
#                                    TextSendMessage(text = text5),
#                                    TextSendMessage(text = text6),
#                                    TextSendMessage(text = text7),
